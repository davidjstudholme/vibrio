      ...
      workdir = ../03_workdir_jasicida # directory where contigs/reads files are located and output is stored

    reference = 1  # 0:pick a random reference; 1:use given reference; 2: use ANI based reference
      reffile = Vibrio_jasicida_CAIM_1864.fasta    # reference filename 

      project = all_vibrio_jasicida-ref_fastree  # main alignment file name
